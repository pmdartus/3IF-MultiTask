/*************************************************************************
                           Menu.h  -  description
                             -------------------
    début                : 23 Jan 2013
    copyright            : (C) 2013 par Mathieu Maranzana
...
//      1. f|F : déclenche la fin de l'application
...
//      est l'option 1. (quitter), c'est à dire la frappe de la touche 'f'
//      ou 'F'
//
// contrat : aucun
//
